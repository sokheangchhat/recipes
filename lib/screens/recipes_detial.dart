...
//                     ),
//                     onPressed: () {
//                       bloc.selectView("colorWhite");
//                       debugPrint("color");
//                       bloc.selectView("colorRed");
//                       debugPrint("color1");
...
//   Widget _colorRed(){
//     debugPrint("for white color.");
//     return IconButton(icon: Icon(Icons.favorite,color: Colors.white,), onPressed: (){});
//   }
//   Widget _colorWhite(){
//     return IconButton(icon: Icon(Icons.favorite,color: Colors.red,), onPressed: (){});
//   }
